...
def main():
    ...
    guide_file = template_dir / "report_data" / "TEMPLATE_POSITION_GUIDE.md"
    
    guide_content = """# Word 模板位置標記指南
...
"""
    ...
    print(f"✓ 指南文件已創建: {guide_file}")
    print("\n請按照指南在 Word 模板中添加變數標記，然後告訴我每個變數對應的數據內容。")
